        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Inventarios_Hoteles_HotelId",
                        column: x => x.HotelId,
                        principalTable: "Hoteles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Inventarios_TiposHabitacion_TipoHabitacionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Inventarios_HotelId_TipoHabitacionId_Fecha",
                table: "Inventarios",
                columns: new[] { "HotelId", "TipoHabitacionId", "Fecha" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Inventarios_TipoHabitacionId",
                table: "Inventarios",
